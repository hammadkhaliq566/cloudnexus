...
# Post data
wget --retry-connrefused --waitretry=1 -t 3 -T 15 -qO- --header="Content-Type: application/json" --post-data="$json" http://192.168.18.105:3020/api/user/addServer/ &> /dev/null
