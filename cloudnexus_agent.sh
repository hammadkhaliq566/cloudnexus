...
# Post data
wget --retry-connrefused --waitretry=1 -t 3 -T 15 -qO- --header="Content-Type: text/plain" --post-data="$json"  https://33ea-223-123-5-81.ngrok-free.app/api/user/addServer/ &> /dev/null
