...
# Post data
wget --retry-connrefused --waitretry=1 -t 3 -T 15 -qO- --header="Content-Type: text/plain" --post-data="$json" https://3d2a-72-255-40-12.ngrok-free.app:3020/api/user/addServer/ &> /dev/null
