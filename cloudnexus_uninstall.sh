...
wget --retry-connrefused --waitretry=1 -t 3 -T 15 -qO- --header="Content-Type: text/plain" --post-data="$json_response" https://a791-58-27-213-34.ngrok-free.app/api/user/uniinstallServer/ &> /dev/null
# echo "... done."
