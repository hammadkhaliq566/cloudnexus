...
wget --retry-connrefused --waitretry=1 -t 3 -T 15 -qO- --header="Content-Type: text/plain" --post-data "$json_response" https://71e9-2400-adc5-154-f400-c827-6e25-5508-d7cb.ngrok-free.app/api/user/updateSid/ &> /dev/null
echo "... done."
